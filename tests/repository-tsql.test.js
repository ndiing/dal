...
class UserRepository extends Repository {
    table = "users";
    columns = {
        id: { type: "INT", primary: true, identity: true },
        name: { type: "VARCHAR", nullable: false },
        email: { type: "VARCHAR", nullable: false },
        age: { type: "INT", nullable: false },
        is_active: { type: "INT", nullable: false },
...
describe("repository-tsql", () => {
    ...
    beforeAll(async () => {
        ...
        await db.schema().createTable("users", (table) => {
            ...
            table.column("is_active").int().default(1);
            table.column("created_at").dateTime().default(db.raw("GETDATE()"));
            table.column("updated_at").dateTime().default(db.raw("GETDATE()"));
